...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      ?>
         <p> <?= $fetch_cart['name']; ?> <span>(<?= 'INR.'.$fetch_cart['price'].'/- x '. $fetch_cart['quantity']; ?>)</span> </p>
      <?php
            }
         }else{
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Province:</span>
            <input type="text" name="state" placeholder="Pune" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
         ...
         <div class="inputBox">
            <span>ZIP CODE :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 410203" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
